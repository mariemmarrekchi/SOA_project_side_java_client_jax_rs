...
<body >
<h2 class="text-center text-success" style="margin-top:50px">Liste des joueurs</h2>
...
if (lp==null)
{
  out.println("<h1> Aucun joueur existant</h1>");
  out.println("<a class='btn btn-success' href ='Form.jsp'>Ajouter un nouveau Joueur </a>");
...
<a class="btn btn-success" href ="Form.jsp">Ajouter un nouveau Joueur </a>
...
<tbody id="myTable">
  ...
  int nb=0;
   for (Iterator it = lp.iterator(); it.hasNext();)
   {
       ...
       out.println("<td><a  class='btn btn-warning' href='ListJoueur?action=editer&id="+p.getId()+"'>Editer</a></td>");
       out.println("<td><a   class='btn btn-danger' href='ListJoueur?action=supprimer&id="+p.getId()+"' onclick='return confirm(\"Voulez vous vraiment supprimer ce Joueur ?\")'>Supprimer</a></td></tr>");
       i++;
   }
  %>
