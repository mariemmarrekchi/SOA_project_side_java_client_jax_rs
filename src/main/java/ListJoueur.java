...
public class ListJoueur extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (action.equals("supprimer"))
        {
            ...
            //rediriger vers ""
            req.getRequestDispatcher("/JoueurController").forward(req, resp);
        }
        else
        {
            if (action.equals("editer"))
            {
                ...
                // lancer la méthode "GET" en précisant le format "JSON" pour la réponse
                ...
                if (!rep.equals("null")) // s'il existe au moins un objet ""
                {
                    ...
                    Joueur pers = gson.fromJson(jo, Joueur.class);
                    //Passer l'objet "pers" comme un attribut dans la requête
                    req.setAttribute("joueur",pers);

                }
                //rediriger vers le formulaire de saisie ".jsp"
